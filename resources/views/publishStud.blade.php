                           ...
                           <tr>
                               ...
                               <td>
                                 <span class="button-checkbox">
                                  <button type="button" class="btn" data-color="success" onclick="appendList({{$student->phone}})">Present</button>
                                  <input type="checkbox" class="hidden" style="display:none" value="{{$student->phone}}" id="{{$student->phone}}"/>
                              </span>
                            </td>
